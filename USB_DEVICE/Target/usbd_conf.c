...
void HAL_PCD_MspInit2(PCD_HandleTypeDef *pcdHandle)
{
...
void HAL_PCD_MspDeInit2(PCD_HandleTypeDef *pcdHandle)
{
  if (pcdHandle->Instance == USB_OTG_FS)
  {
  ...
  else if (pcdHandle->Instance == USB_OTG_HS)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_10 | GPIO_PIN_11 | GPIO_PIN_12 | GPIO_PIN_13 | GPIO_PIN_5);
